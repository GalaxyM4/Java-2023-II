...
public class YTMusic extends Player {
    ...
    public void start_music(int opt)  {
        try {
            ...
            PrintColor.printlnColor("(0:00/"+(int)(m_class.time/60)+":"+(int)(m_class.time%60)+")", PrintColor.WHITE_BACKGROUND);
            ...
            while (seconds < m_class.time) {
                ...
                PrintColor.printlnColor(m_class.name, PrintColor.CYAN);
                if(sec < 10) {
                    PrintColor.printlnColor("("+minutes+":0"+sec+"/"+(int)(m_class.time/60)+":"+(int)(m_class.time%60)+")", PrintColor.WHITE_BACKGROUND);
                }else {
                    PrintColor.printlnColor("("+minutes+":"+sec+"/"+(int)(m_class.time/60)+":"+(int)(m_class.time%60)+")", PrintColor.WHITE_BACKGROUND);
                }
